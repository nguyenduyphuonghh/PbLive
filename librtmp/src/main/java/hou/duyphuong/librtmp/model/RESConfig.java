package hou.duyphuong.librtmp.model;
...
public class RESConfig {
    ...
    public static RESConfig obtain() {
        ...
        res.setBitRate(2500000);
        res.setPrintDetailMsg(false);
        res.setDefaultCamera(Camera.CameraInfo.CAMERA_FACING_FRONT);
        res.setBackCameraDirectionMode(DirectionMode.FLAG_DIRECTION_ROATATION_90);
        res.setFrontCameraDirectionMode(DirectionMode.FLAG_DIRECTION_ROATATION_90);
        return res;
    }

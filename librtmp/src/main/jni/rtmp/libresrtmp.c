...
#include "rtmp.h"
/*
 * Class:     hou_duyphuong_librtmp_rtmp_RtmpClient
 * Method:    open
 * Signature: (Ljava/lang/String;)I
 */
 JNIEXPORT jlong JNICALL Java_hou_duyphuong_librtmp_rtmp_RtmpClient_open
 ...
 * Signature: ([CI)I
 */
 JNIEXPORT jint JNICALL Java_hou_duyphuong_librtmp_rtmp_RtmpClient_read
 ...
 * Signature: ([CI)I
 */
 JNIEXPORT jint JNICALL Java_hou_duyphuong_librtmp_rtmp_RtmpClient_write
 ...
 * Signature: ()I
 */
 JNIEXPORT jint JNICALL Java_hou_duyphuong_librtmp_rtmp_RtmpClient_close
...
JNIEXPORT jstring JNICALL Java_hou_duyphuong_librtmp_rtmp_RtmpClient_getIpAddr
